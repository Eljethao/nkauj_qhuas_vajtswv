...
class HundredOldDetail extends StatefulWidget {
  final String title;
  final String type;
  const HundredOldDetail({super.key, required this.title, required this.type});

  @override
  State<HundredOldDetail> createState() => _HundredOldDetailState();
}

class _HundredOldDetailState extends State<HundredOldDetail> {
  String? path;
  ...
  loadPdf() async {
    try {
      String _documentPath = 'assets/files/100-qub.pdf';
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: DropdownSearch<String>(
                              ...
                              items: oldHundredTitles
                                  .map((title) => title['title'] as String)
                                  .toList(),
                              onChanged: (String? data) {
                                // Find the map in oldHundredTitles that corresponds to the selected title
                                final selectedTitle = oldHundredTitles.firstWhere(
